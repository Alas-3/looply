        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Forget complex employee management tools.
            </p>
          </div>
                ...
                <div className="w-full">
                  <div className="bg-gray-50 rounded-lg p-4 mb-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                        <span className="text-xs text-gray-700">Mike Chen</span>
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl shadow-lg p-6 mb-4 h-64 flex items-center justify-center">
                <div className="w-full">
                  ...
                  <div className="bg-yellow-400 rounded-lg p-3 mb-2 relative">
                    <div className="text-xs font-bold text-black">04:21</div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="bg-gray-100 rounded p-2 text-xs">85</div>
                    <div className="bg-gray-100 rounded p-2 text-xs">09</div>
                    <div className="bg-gray-100 rounded p-2 text-xs">—</div>
                  </div>
                </div>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">
              ...
              <p className="text-gray-600">
                Personalize your dashboard with themes, widgets, and layouts
                that work for you.
              </p>
            </div>
          </div>
